...
public class PedidoController {
	...
	@GetMapping("/delivery")
	public ResponseEntity<List<PedidoDTO>> findDelivery() {
		return ResponseEntity.ok(this.pedidoService.findByMetodo("D"));
	}

	@GetMapping("/recoger")
	public ResponseEntity<List<PedidoDTO>> findRecoger() {
		return ResponseEntity.ok(this.pedidoService.findByMetodo("R"));
	}

	@GetMapping("/local")
	public ResponseEntity<List<PedidoDTO>> findLocal() {
		return ResponseEntity.ok(this.pedidoService.findByMetodo("L"));
	}

	@GetMapping("/hoy")
	public ResponseEntity<List<PedidoDTO>> findHoy() {
		return ResponseEntity.ok(this.pedidoService.findToday());
	}

	@GetMapping("/cliente/{idCliente}")
	public ResponseEntity<List<PedidoDTO>> findPedidosByCliente(@PathVariable int idCliente) {
		if (!this.clienteService.existsCliente(idCliente)) {
			return ResponseEntity.notFound().build();
		}
		return ResponseEntity.ok(this.pedidoService.findCliente(idCliente));
	}
