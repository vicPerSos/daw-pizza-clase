...
public class PedidoService {
	...
	public List<PedidoDTO> findByMetodo(String metodo) {
		List<PedidoDTO> pedidosDTO = new ArrayList<PedidoDTO>();

		for (Pedido p : this.pedidoRepository.findByMetodo(metodo)) {
			pedidosDTO.add(PedidoMapper.toDto(p));
		}
		return pedidosDTO;
	}

	public List<PedidoDTO> findToday() {
		List<PedidoDTO> pedidosDTO = new ArrayList<PedidoDTO>();
	...
	public List<PedidoDTO> findCliente(int idCliente) {
		List<PedidoDTO> pedidosDTO = new ArrayList<PedidoDTO>();
